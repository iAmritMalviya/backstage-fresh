...
import { Table, TableColumn, Progress, ResponseErrorPanel, UserIdentity } from '@backstage/core-components';
...
export const DenseTable = async ({ users }: DenseTableProps) => {
...
export const ExampleFetchComponent = async  () => {
